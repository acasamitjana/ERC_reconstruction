...
# Directories
BASE_DIR =  join(RESULTS_DIR, 'P57-16')
...
initial_bid_list_B = ['B1.1', 'B2.1', 'B3.1', 'B4.1', 'B5.1']
...
# Linear registration params:
device = 'cuda:0'
training_params = {
    'starting_iteration': 1,
    'n_iterations': 11,
    # Eugenio: new schedule
    'schedule': [0,   1,   0,   2,   0,   3,   0,   4,   0,   4,   5],
    # lbfgs run
    'nepochs': [20, 20, 20, 20, 10, 40, 20, 40, 20, 20, 40],#, 20, 50, 100, 50, 100, 50, 100, 50, 100, 50],
    # LBFGS
    'learning_rate': [0.01, 0.005, 0.01, 0.005, 0.01, 0.005, 0.01, 0.005, 0.01, 0.05, 0.2],
    'mask_weight': [5] * 11, # global overlap weight; this multiplies all the structure specific ones
    'mask_cll_weight': [1] * 11,  # cerebellum overlap weight
    'mask_cr_bs_weight': [1] * 11,  # cerebrum overlap weight
    'image_weight': [1] * 11, # intensity loss weight
    'scale_weight': [0.05] * 11,  # scaling loss weight
    ...
    'alpha_weight': [1] * 11, # [2] * 11,  # parameter in overlap weight (for overlaps)
    'beta_weight': [1] * 11,  # parameter in overlap weight (for gaps)
